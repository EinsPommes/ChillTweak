...
function Show-Menu {
    ...
    Write-Host "[6]  Software-Installation" -ForegroundColor $script:secondaryColor
    Write-Host "[7]  System-Reinigung" -ForegroundColor $script:secondaryColor
    Write-Host "[8]  Windows-Dienste" -ForegroundColor $script:secondaryColor
    Write-Host "[9]  Backup & Wiederherstellung" -ForegroundColor $script:secondaryColor
    Write-Host "[10] Windows Updates" -ForegroundColor $script:secondaryColor
    Write-Host "[11] Hilfe & Informationen" -ForegroundColor $script:secondaryColor
    Write-Host "[12] Sprache ändern" -ForegroundColor $script:secondaryColor
